...
class Node2Vec:
    ...
    def __init__(self, graph, start_node, walk_length, num_walks, p=1.0, q=1.0, workers=1, use_rejection_sampling=0):
        ...
        self.sentences = self.walker.simulate_walks(
            num_walks=num_walks, walk_length=walk_length, start_node=start_node, workers=workers, verbose=1)
